...
const { registerStudent, getStudent, getAllStudents, updateStudent, deleteStudent, csvStudent, getAllHostelNames } = require('../controllers/studentController');


// @route  POST api/student/register-student
// @desc   Register student
// @access Public
router.get('/getallhostelnames',getAllHostelNames);
